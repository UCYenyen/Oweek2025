    ...
    <div className="w-full">
      <div className="relative w-full max-w-4xl mx-auto bg-slate-200 rounded-2xl p-6 md:p-8 shadow-lg">
        ...
        <div className="flex flex-col items-center mt-6 md:mt-8">
          <h1 className="pt-4 text-slate-900 font-bold text-3xl md:text-4xl">
            {schedule.title}
          </h1>
          <h2 className="text-slate-900 text-lg md:text-xl mt-2">
            {schedule.date}
          </h2>
          <h3 className="text-slate-900 text-lg md:text-xl mt-1">
            {schedule.location}
          </h3>
