  ...
  return (
    <div className="relative flex flex-col items-center justify-center py-8">
        ...
        <div className="flex flex-col items-center">
          <div className="bg-slate-200/50 text-white rounded-lg w-50 h-65 flex items-center justify-center text-[90px] font-bold backdrop-blur-[4px] border-5 border-white">
            {timeLeft.days}
          </div>
